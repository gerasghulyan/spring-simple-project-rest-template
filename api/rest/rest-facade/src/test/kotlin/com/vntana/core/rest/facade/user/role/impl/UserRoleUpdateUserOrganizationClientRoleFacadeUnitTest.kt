...
class UserRoleUpdateUserOrganizationClientRoleFacadeUnitTest: AbstractUserRoleServiceFacadeUnitTest() {
    ...
    fun `test grant client roles to organization admin`() {
        ...
        expect(userRoleActionItemRetrieverComponent.fetchRevokeRolesFromUpdateRolesRequest(request)).andReturn(listOf(revokeClientRole))
        ...
        expect(userRoleActionItemRetrieverComponent.fetchGrantRolesFromUpdateRolesRequest(request)).andReturn(listOf(grantClientRole))
