 ...
 * Time: 5:17 PM
 */
class InvitationUserToOrganizationFacadePreconditionCheckerCheckAcceptAndSignUpForPossibleErrorsUnitTest : AbstractInvitationUserFacadePreconditionCheckerFacadeUnitTest() {
    ...
    fun `test when invitation not found for token`() {
        ...
        replayAll()
        preconditionChecker.checkAcceptAndSignInvitationToOrganizationUpForPossibleErrors(request).let {
    ...
    fun test() {
        ...
        replayAll()
        assertThat(preconditionChecker.checkAcceptAndSignInvitationToOrganizationUpForPossibleErrors(request).isPresent).isFalse()
        verifyAll()
    }
}