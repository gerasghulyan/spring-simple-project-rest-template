 ...
 * Time: 11:49 AM
 */
abstract class AbstractUserRoleFacadePreconditionCheckerComponentUnitTest : AbstractServiceFacadeUnitTest() {
    ...
    @Before
    fun prepare() {
        preconditionChecker = UserRoleFacadePreconditionCheckerComponentImpl(organizationService, userService, userRoleService)
    }
}