...
abstract class AbstractUserRoleFacadePreconditionCheckerComponentUnitTest : AbstractFacadeUnitTest() {
    ...
    @Before
    fun prepare() {
        preconditionChecker = UserRoleFacadePreconditionCheckerComponentImpl(organizationService, userService, userRoleService, clientOrganizationService, userRolesPermissionsCheckerComponent)
    }
}