 ...
 * Time: 2:03 PM
 */
public class TokenAuthenticationRequest extends AbstractRequestModel implements ValidatableRequest<TokenAuthenticationErrorResponseModel> {
    ...
    public TokenAuthenticationRequest(final String token) {
        this.token = token;
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof TokenAuthenticationRequest)) {
            return false;
        }
        final TokenAuthenticationRequest that = (TokenAuthenticationRequest) o;
