 ...
 * Time: 11:17 AM
 */
public class InvitationUserToOrganizationEmailSendPayload extends AbstractTemplateEmailSendPayload {
    ...
    public InvitationUserToOrganizationEmailSendPayload(final String templateName,
