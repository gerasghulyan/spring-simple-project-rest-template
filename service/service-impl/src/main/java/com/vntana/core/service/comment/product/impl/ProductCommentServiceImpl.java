...
class ProductCommentServiceImpl implements ProductCommentService {
    ...
    public Page<ProductComment> findByProductUuid(final ProductCommentFindByProductUuidDto dto) {
        ...
        Page<ProductComment> productComments = productCommentRepository.findByProductUuidAndRemovedIsNullOrderByCreatedDesc(dto.getProductUuid(), PageRequest.of(dto.getPage(), dto.getSize()));
