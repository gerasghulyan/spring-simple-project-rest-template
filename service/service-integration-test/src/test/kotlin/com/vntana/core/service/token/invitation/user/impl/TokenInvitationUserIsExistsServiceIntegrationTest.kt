...
class TokenInvitationUserIsExistsServiceIntegrationTest : AbstractTokenInvitationUserServiceIntegrationTest() {
    ...
    fun `test when does not exist`() {
        assertThat(tokenInvitationUserService.existsInvitationToOrganizationByToken(uuid())).isFalse()
    }
    ...
    fun test() {
        ...
        flushAndClear()
        assertThat(tokenInvitationUserService.existsInvitationToOrganizationByToken(tokenInvitationUser.token)).isTrue()
    }
}